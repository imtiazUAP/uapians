    ...
    <div id="grad1">
        <div class="bodydiv">
            ...
            <div class="realbodyforprofile">
                ...
                ?>
                <?php
                $strquery = "SELECT *,SMName,Blood_Group_Name,district_name FROM s_info INNER JOIN sm_info ON s_info.SMID=sm_info.SMID INNER JOIN blood_group_info ON s_info.Blood_Group_ID=blood_group_info.Blood_Group_ID INNER JOIN districts ON s_info.district_id=districts.district_id WHERE SID='" . $_GET["SID"] . "'";
                ...
                <div id="margin_figure_profile">
                    ...
                    <p style="padding-top:10px; color:#FFFFFF; font-size:16px">Blood
                        Group: <?php echo $Blood_Group; ?></P>
                    <br>
