...
$strquery="SELECT project.SID,project.project_name,project.project_screenshot,project_link,cat_name,SName,platform_name FROM project INNER JOIN project_category_table ON project.project_cat_id=project_category_table.cat_id INNER JOIN s_info ON project.SID=s_info.SID INNER JOIN platform_table ON project.platform_id=platform_table.platform_id WHERE project.language_id='10'";
