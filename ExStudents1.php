...
<a href="Student_Insert.php?keepThis=true&TB_iframe=true&height=350&width=280&modal=true" title="New Student" class="thickbox">Create New Student</a>
	...
	<td width="100">
	<?php echo " <a href='Student_Edit.php?SID=" . $SID . "&keepThis=true&TB_iframe=true&height=300&width=500&do=edit&modal=true'     	class='thickbox' title='Edit Student - ".$f2."'> edit </a> "; ?> | <?php echo " <a href='Student_Delete.php?SID=" . $SID . "'> delete </a> ";?></td>
	 				<?php
	 				}
	 				?>
