                ...
                <form id="form1" name="form1" method="get" action="my_profile_teacher_update.php">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><textarea name="employee_Contact" cols="80" rows="5" style="border:inset" type="text" id="EName"><?php echo $row["Employee_Contact"]; ?></textarea>
                            </td>
                        </tr>
                    ...
                    <div style="float: right; padding-right: 125px;">
                        <button  class="button button_blue" type="submit">->>Update Profile</button>
                    </div>
