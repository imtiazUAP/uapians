<div>
    <div>
        <div id="section_head">
            <h1 align="left" style="color:#FFFFFF;font:Georgia, 'Times New Roman', Times, serif ">About
                Us</h1>
        </div>
        <td width="100"><img src="<?= BASE_URL . '/app/assets/images/11201028.jpg' ?>" style="height:250px; padding:10px" align="right"></td>
        <td width="100"><img src="<?= BASE_URL . '/app/assets/images/11201037.jpg' ?>" style="height:250px; padding:10px" align="right"></td>
    ...
    <div>
        ...
        <td width="100"><img src="<?= BASE_URL . '/app/assets/images/Najmus_Sadat.jpg'?>" style="height:250px; padding:10px" align="right"></td>
        <td width="100"><img src="<?= BASE_URL . '/app/assets/images/Bijan_Paul.jpg'?>" style="height:250px; padding:10px" align="right"></td>
        <td width="100"><img src="<?= BASE_URL . '/app/assets/images/Faruk_Ahmed.jpg'?>" style="height:250px; padding:10px" align="right"></td>
        <td width="100"><img src="<?= BASE_URL . '/app/assets/images/Saidur_Rahman.jpg'?>" style="height:250px; padding:10px" align="right"></td>
        <td width="100"><img src="<?= BASE_URL . '/app/assets/images/Sharif_Zaman.jpg'?>" style="height:250px; padding:10px" align="right"></td>
        ...
        <p style="font-size:20px">Faruk Ahmed</p> <p>Microsoft Developer হিসাবে দীর্ঘদিন কাজ করার
        ...
        মানুষটির অবদান সবথেকে বেশী। তাদের যে কোন সমস্যায় রাত-দিন যে কোন সাহায্য তিনি করেছেন।</p>
        <br>
        <p style="font-size:20px">Bijon Paul</p><p>ওই সময় তাদের ডাটাবেজের Course Teacher ছিলেন।
        ...
        মতো নয়। Admin দের ডাটাবেজে হাতেখড়ি উনার কাছেই।</p>
        <br>
        <p style="font-size:20px">Dr. Najmus Sadat</p> <p>পড়ালেখা শেষ করেছেন অস্ট্রেলিয়ার Monash
        University থেকে উনি বর্তমানে Assistant প্রফেসর হিসাবে দায়িক্তপালন করছেন University of
        Asia Pacific এ। অ্যালগরিদম সংক্রান্ত সকল জটিলতায় ইমতিয়াজের পাশে ছিলেন উনি সর্বদা...</p>
        <br>
        <p style="font-size:20px">Sharif Zaman</p> <p>জুনিয়র ইঞ্জিনিয়ার,Epsilon Consulting Ltd.
        পড়াশোনা করেছেন CSE তেই University of Development Alternative থেকে তার পাশে বসেই করা
        হয়েছে ডিজাইনের সব কাজ।</p>
        <br>
        <p style="font-size:20px">S.M. Saidur Rahman</p> <p>Senior Engineer at Epsilon Consulting
