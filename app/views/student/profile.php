				...
				<?php include (__DIR__ . "/../partials/logo.php"); ?>
					...
					<?php include (__DIR__ . "/../partials/menu.php"); ?>
						<div class="profileuserinterface">
							...
							if (1) { ?>
									<div align="center" style="background-color:#FFFF00; width:500px; height:20px">
										...
										<a href="<?= BASE_URL . '/student/edit?SID='. $studentInfo['SID'] . '&keepThis=true&TB_iframe=true&height=543&width=400&do=edit&modal=true' ?>" class='thickbox' title='Edit Student - " . $studentInfo["SName"] . "'> Edit my Profile </a>
						...
						<div id="margin_figure_profile">
							...
							<br>
							<br>
							<p style="padding-top:1px; color:#FFFFFF; font-size:16px">Registration No: <?php echo $studentInfo["SReg"]; ?></P>
							<br>
							...
							<br>
							<p style="padding-top:10px; color:#FFFFFF; font-size:16px">Blood Group: <?php echo $studentInfo["Blood_Group_Name"]; ?>
							</P>
							<br>
							<p style="padding-top:10px; color:#FFFFFF; font-size:16px">House: <?php echo $studentInfo["SHouse"]; ?></P>
							<br>
							<p style="padding-top:10px; color:#FFFFFF; font-size:16px">Home City: <?php echo $studentInfo["SHome_City"]; ?></P>
							<br>
