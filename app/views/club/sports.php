<div>
    <div>
        <div id="section_head">
            <h1 align="left" style="color:#FFFFFF;font:Georgia, 'Times New Roman', Times, serif ">Sports Club
            </h1>
        </div>
        ...
        <p align="left">To promote and develop individual interests in various sports and
            ...
            responsibility, decision-making, public relations, organization, and fiscal
            management.
    ...
    <div>
        ...
        <p>
            The Club will arrange at least one intradepartmental sports competition in an
            academic year on regular basis.
            <br>
            ...
            <br>
            For outdoor games the Club will manage a sports field on part-time basis. Say, 3
            days per week starting from 2pm.
            <br>
            The Club can manage some sort of training for both indoor and outdoor games.
        </p>
    </div>
    <br>
    <br>
