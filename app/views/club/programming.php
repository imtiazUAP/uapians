<div>
    <div>
        <div id="section_head">
            <h1 align="left" style="color:#FFFFFF;font:Georgia, 'Times New Roman', Times, serif ">Programming
                Contest Club</h1>
        </div>
        <p align="left" style="font-size:16; font-weight:bold">Welcome to CSE Programming
            contest Club....</p>
        <p align="left">In the recent years ACM International Collegiate Programming Contest
            (ICPC) has achieved immense importance in the computer science arena. Bangladesh has
            also become successful to put its footmark in the same. BUET has been attending in
            the world finals consecutively six times since 1998 by becoming champions in the
            international regional contests. In this connection it could be added that
            universities from almost every Asian countries participate in these hard-fought
            regional contests to qualify for the world final.
            The goal of this club is to develop students of UAP to participate in different
            national and regional contests and arrange programming contests of both national and
    ...
    <div>
        ...
        <marquee behavior="scroll" direction="up" onMouseOver="this.stop();" onMouseOut="this.start();" align="middle" ;
            style="color:#0099FF; font-size:18px; height:300">
            <a href='http://devfest.ydesh.com/' style="text-decoration:none; color:#FFFFFF"><span>DevFest The Coolest
                    Developer
            ...
            <a href='http://www.ictd.gov.bd/bangla/' style="text-decoration:none; color:#99FF99">Newsletter from
                National Mobile
            ...
            <a href='http://www.uap-bd.edu/' style="text-decoration:none; color:#FFFF33"><span>Convocation of University
                    of
            ...
            <a href='http://devfest.ydesh.com/' style="text-decoration:none; color:#FFFF00""><span>DevFest The Coolest Developer Conference 30-31 August 2013</span></a><br> <br>
                                    <a href='http://devfest.ydesh.com/' style=" text-decoration:none;
                color:#FF33CC;font-size:25px;"><span>DevFest The
                    Coolest Developer Conference 30-31 August 2013</span></a><br> <br>
            <a href='Link: http://www.eventbrite.com/event/10239078359' style="text-decoration:none"><span>It's Raining
                    Opportunities ! Google Developer
            ...
            <a href='http://www.scholars4dev.com/8054/univeristy-west-england-scholarships-for-international-students/'
                style="text-decoration:none; color:#FF33CC"><span>A Big Scholarship Opportunity
                    for All Bangladeshi Students</span></a><br> <br>
            <a href='http://devfest.ydesh.com/' style="text-decoration:none; color:#99FF99"><span>DevFest The Coolest
                    Developer
                    Conference 30-31 August 2013</span></a><br> <br>
            <a href='Link: http://www.eventbrite.com/event/10239078359'
                style="text-decoration:none; color:#FFFF00;font-size:25px"><span>It's Raining
                    Opportunities ! Google Developer Group Bangladesh</span></a><br> <br>
            <a href='http://www.ictd.gov.bd/bangla/' target="iframe" style="text-decoration:none"><span>Newsletter from
            ...
            <a href='http://uap-bd.edu/notice/suspended-25-02-2014.html' target="iframe"
                style="text-decoration:none; color:#99FF99;font-size:25px"><span>All classes of
                    UAP will be suspended on 25 February</span></a><br> <br>
            <a href='http://www.uap-bd.edu/' target="iframe" style="text-decoration:none; color:#FF33CC"
                ;font-size:25px;><span>Convocation
    ...
    <div>
        ...
        <p align="left" style="font-size:16; font-weight:bold">To achieve the goal, the club
            will undertake following activities...
        </p>
        <p align="left">
            Arrange regular coaching programs for students to motivate them for participating in
            the competition and also to enrich their problem solving capability.
            <br>
