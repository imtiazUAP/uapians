<div>
    <div>
        <div>
            <div id="section_head">
                <h1 align="left" style="color:#FFFFFF;font:Georgia, 'Times New Roman', Times, serif ">CSE
                    Cultural & Debating Club</h1>
            </div>
            <td width="100"><img src="<?= BASE_URL . '/app/assets/images/shaila_mam1.jpg' ?>" style="height:250px; padding:10px" align="right"></td>
    ...
    <div id="wowslider-container1" style="height:267">
        <div class="ws_images">
            <ul>
                <li><img src="<?= BASE_URL . '/app/assets/Cultural_Club/data1/images/1176353_10201824031220250_299244289_n.jpg' ?>"
                        alt="FareWell Organised by CSe Cultural CLub" title="FareWell Organised by CSe Cultural CLub"
                        id="wows1_0" /></li>
                <li><img src="<?= BASE_URL . '/app/assets/Cultural_Club/data1/images/12177_4319308698703_1275228451_n.jpg' ?>" alt="" Pitha
                        Utshob" Organised by CSE Cultural Club" title="" Pitha Utshob" Organised by CSE Cultural Club"
                        id="wows1_1" /></li>
                <li><img src="<?= BASE_URL . '/app/assets/Cultural_Club/data1/images/971296_594950683868503_1156440747_n.jpg' ?>" alt="" title=""
                        id="wows1_2" /></li>
            </ul>
        </div>
        <div class="ws_bullets">
            <div>
                <a href="#" title="FareWell Organised by CSe Cultural CLub"><img
                        src="<?= BASE_URL . '/app/assets/Cultural_Club/data1/tooltips/1176353_10201824031220250_299244289_n.jpg' ?>"
                        alt="FareWell Organised by CSe Cultural CLub" />1</a>
                <a href="#" title="" Pitha Utshob" Organised by CSE Cultural Club"><img
                        src="<?= BASE_URL . '/app/assets/Cultural_Club/data1/tooltips/12177_4319308698703_1275228451_n.jpg' ?>" alt="" Pitha
                        Utshob" Organised by CSE Cultural Club" />2</a>
                <a href="#" title=""><img
                        src="<?= BASE_URL . '/app/assets/Cultural_Club/data1/tooltips/971296_594950683868503_1156440747_n.jpg' ?>" alt="" />3</a>
            </div>
        </div>
    ...
    <script type="text/javascript" src="<?= BASE_URL . '/app/assets/Cultural_Club/engine1/wowslider.js' ?>"></script>
    <script type="text/javascript" src="<?= BASE_URL . '/app/assets/Cultural_Club/engine1/script.js"' ?>></script>
    <br>
    <br>
    <br>
    <div>
