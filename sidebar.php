	...
	<div class="box">
		<div id="paragraph_head">
			<h3 align="left" style="color:#FFFFFF;font:Georgia, 'Times New Roman', Times, serif ">Admin Panel</h3>
				...
				<ul>
				<a href="Admin_Nokib.php"><li><img src="images/1234554321.jpg" style="height:100"/>  Nokib Mozumder</li></a>
			...
			<li><a href="send_message_to_admin.php">Send him a Message</a></li>
				...
				<a href="Admin_Jihan.php"><li><img src="images/Picture 2963.jpg" style="height:100"/>MD. Mazharul islam jihan</li></a>
