...
<body>
  ...
  $strquery = "UPDATE s_info SET SName= '" . $_GET['SName'] . "', SReg= '" . $_GET['SReg'] . "',SHouse= '" . $_GET['SHouse'] . "',district_id= '" . $_GET['district_id'] . "',SPh_Number= '" . $_GET['SPh_Number'] . "',email= '" . $_GET['email'] . "',SB_of_Date= '" . $_GET['SB_of_Date'] . "',SPortrait= '" . $_GET['SPortrait'] . "',SMID= '" . $_GET['SMID'] . "'
