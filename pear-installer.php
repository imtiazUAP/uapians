...
function displayHTMLHeader()
{
    ...
    <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000" link="#006600"
        alink="#cccc00" vlink="#003300">
        <?php
}
// }}}
// {{{ displayHTML
                                        ...
                                        <td>
                                            ...
                                            if ($page == 'error') {
                                                ...
                                                <p>
                                                    ...
                                                    packages:
                                                    <?php echo implode(', ', array_keys($GLOBALS['pfc_packages'])); ?>.
                                                </p>
                                                ...
                                                <form action="<?php echo basename(__FILE__); ?>?step=install" method="post">
                                                    ...
                                                    <table border="0">
                                                        ...
                                                        foreach ($GLOBALS['pfc_packages'] as $var => $descr) {
                                                            ...
                                                            printf(
                                                                '<tr><td align="center"><input type="checkbox" name="%s"%s></td><td>%s</td><td>%s</td></tr>',
                                                                $var,
                                                                $checked,
                                                                $var,
                                                                $descr
        ...
        -->
                                                    <table border="0" width="80%">
                                                        ...
                                                        foreach ($GLOBALS['config_vars'] as $n => $var) {
                                                            ...
                                                            printf(
                                                                '<tr><td>%d. %s</td><td><input type="text" name="config[%s]" value="%s"%s></td></tr>',
                                                                $n,
                                                    ...
                                                    <ul>
                                                        <p>
                                                            ...
                                                            <input type="text" name="proxy[host]"
                                                                ...
                                                                name="proxy[port]" value="<?php echo $proxy_port; ?>" size="6">
                                                        </p>
                                                        <p>
                                                            <li />Compatibility-Mode for old non-DOM Browsers <input
                                                                type="checkbox" name="BCmode" id="BCmode" checked>
                                ...
                                if (document.getElementById('BCmode')) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span style="color: #ff0000">
                                                                        ...
                                                                        in your PHP binary. If the installation crashes you might
                                                                        want to update your PHP version.</br>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <table border="0">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="green">
                                                                    <b>Note:</b> Installation might take some time, because
                                                                    go-pear has to<br />
                                                                    download all needed files from pear.php.net. Just be patient
                                                                    and wait for<br />
                                                ...
                                                <p>
                                                    ...
                                                    <i>(If the page stops loading before the end of the installation, then just
                                                        reload it)</i>
                                                </p>
                                                <script type="text/javascript">
                                                    <!-
