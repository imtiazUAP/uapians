...
?>
	...
	<ul>
			<li style="vertical-align:middle;"><a href='Profile_List.php'><span><img style="width:15px; height:15px; border:1px solid white; vertical-align:middle"src="<?php echo $SPortrait; ?>" alt="Profile Picture"><span> Profile</span></a></li>
...
<?php
  ...
  ?>
		...
		<div class="footer" align="center">
 		<a href="http://www.emtiaj.blogspot.com" class="copyright" style="text-decoration:none">copyright @ www.emtiaj.blogspot.com</a> <br>
		<a href="http://uap-bd.edu/cse/index.html" class="copyright" style="text-decoration:none">copyright @ CSE Department, UAP</a> <br>			 
		</div>
