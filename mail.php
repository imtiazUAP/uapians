...
<body style="background-color:#661D79">
          ...
          if (!isset($_POST["submit"])) {
            ...
            <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
              <table style="color:#FFFFFF">
                <tr>
                  <td>From:</td>
                  <td><input type="text" name="from" placeholder="email address"><br></td>
                </tr>
                <tr>
                  <td>Subject:</td>
  ...
  <div class="footer" align="center">
    <p>Copyright@<a href="http://www.twocolorbd.com"
        style=" color:#DB3937; text-decoration:none">www.TwoColorbd.com</a>|||||||||||Developed by <a
        href="http://www.facebook.com/iliton" target="_blank" style=" color:#DB3937; text-decoration:none">Imtiaz
        Ahmad</a></p>
  </div>
</body>
