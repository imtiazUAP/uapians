...
<?php } else {
    ...
    <div class="realbody" style="min-height:2300px">
        ...
        <div class="profileuserinterface">
            ...
            if (($userdata['SID'] == $SID)) {
            ?>
                <div align="center" style=" width:1000px; height:20px; color: #ffffff; font-size: 16px">
...
<a style="background-color: #FF8E65;" href='photo_update.php?SID=<?= $SID ?>&keepThis=true&TB_iframe=true&height=260&width=450&do=edit&modal=true' class='thickbox' title='Change Profile Photo -<?= $Name ?>'>  Change Profile Photo </a>
                </div>
            <?php
            }
            ?>
