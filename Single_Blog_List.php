...
<div style="padding-bottom:100px; padding-right:50px; color:#FFFFFF">
	<img style="padding:2px;border:2px solid white;margin:0px; font-size:18px"src="<?php echo $SPortrait; ?>" alt="Smiley face"
	width="40" height="50">
<div style="padding:2px; font-weight:bold"><?php echo $SName ; ?> </div>
<div style="padding:2px;border:1px solid white;margin:0px; font-size:12px; width:500px";><?php echo $Comment ; ?> </div>
		<br>
...
<div style="font-weight:bold;font-size:20px; color:#FFFFFF;">Comments:</div>
