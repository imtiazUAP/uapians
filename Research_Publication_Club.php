...
?>
	...
	<div id="colOne">
		...
		<div class="box">
		<div id="paragraph_head">
			<h3  align="left" style="color:#FFFFFF;font:Georgia, 'Times New Roman', Times, serif ">Environment and Facilities</h3>
			</div>.
			<ul class="bottom">
...
<div id="margin_figure">
	...
	<div>
	<div id="paragraph_head">
	<h1 align="left" style="color:#FFFFFF;font:Georgia, 'Times New Roman', Times, serif ">UAP a School of Research</h1>
	</div>
	<p align="left" style="font-size:16; font-weight:bold">Research and Publication Club</p>
	<p align="left">This club organizes a technical or IT based seminar each month. It also publishes technical journal each year. It helps the students and faculty members of CSE Department to improve their research capability producing quality computer professionals who can make positive contribution in the development of this country. In the budget of The University of Asia Pacific (UAP), some amount of money is dedicated for research and publication. Most of our faculty members and students of UAP are engaged to publish their quality work at home and abroad. A faculty member of CSE Department recently visited Nepal to represent his papers at ITPC-2003 that reflects the fact.
</p>
    </div>
	<br>
<br>
