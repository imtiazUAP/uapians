...
<a href="Student_Insert.php?keepThis=true&TB_iframe=true&height=350&width=280&modal=true" title="New Student" class="thickbox">Create New Student</a>
	...
	$strquery="SELECT SID,SName,SReg,SPortrait,SMName FROM s_info INNER JOIN sm_info ON s_info.SMID=sm_info.SMID WHERE s_info.SMID='9' order by SReg DESC";
	...
	$semester=mysql_result($results,$i,"SMName");
                                    ...
                                    $sql = "SELECT SID,SName,SReg,SPortrait,SMName FROM s_info INNER JOIN sm_info ON s_info.SMID=sm_info.SMID WHERE s_info.SMID='9' order by SReg DESC";
 ...
 <?php
                                                ...
                                                <td > <a href='Single_Mark_List.php? SID=<?= $data['SID'] ?>'> Results </a></td>
                                                    ...
                                                    <td width="100">
                                                        <a href='Student_Edit.php?SID=<?= $data['SID'] ?>&keepThis=true&TB_iframe=true&height=300&width=350&do=edit&modal=true' class='thickbox'> edit </a> | <a href='Student_Delete.php?SID=<?= $data['SID'] ?>'> delete </a>
                                                    </td>
                                                <?php
                                                }
                                                ?>
