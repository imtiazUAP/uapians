        ...
        <div id="grad1">
            <div class="bodydiv">
                ...
                <div class="realbody">
                    <?php
                    include("menu.php");
                    $strquery="SELECT *,SMName,Blood_Group_Name FROM s_info INNER JOIN sm_info ON s_info.SMID=sm_info.SMID INNER JOIN blood_group_info ON s_info.Blood_Group_ID=blood_group_info.Blood_Group_ID WHERE SID='239'";
