                    ...
                    if ($message == 'confirmation_mail') {
                        ...
                        <div align="center">
                            <label style="color: white; font-size:14px;">Account not found with this <span
                                    ...
                                    href="sign_up.php">Sign Up</a> to continue... </br> or <a style="color: #ff0000"
                                    href="reset_pass.php">click here</a> to try with a different Email address</label>
                        </div>
                        <?php
                        ...
                        <div align="center">
                            <label style="color: white; font-size:14px;">Opps!! <span style="color: #ff0000">wrong login
                                    info</span> provided. Please try again or if you forgot your password... </br> <a
                                    style="color: #50B9E8" href="reset_pass.php">click here to reset your
                                    password</a></label>
                        </div>
                        <?php
                    } else {
                        if (isset($_GET['action'])) {
                                        ...
                                        <div align="center">
                                            <label style="color: white; font-size:14px;">Invalid verification link, or this verification
                                                link is already used one time. </br> Please try again... <a style="color: #ff0000"
                                                    href="reset_pass.php">Forget Password?</a></label>
                                        </div>
                                        <?php
                                }
                            }
                            ...
                            if (count($Results[userid]) >= 1) {
                                ...
                                ?>
                                    ...
                                    <div align="center">
                                        <label style="color: white; font-size:14px;">Your password changed sucessfully... <a
                                                style="color: #ff0000" href="index.php">click here to login</a></label>
                                    </div>
                                    <?php
                            } else {
                                ?>
