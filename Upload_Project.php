                    ...
                    <div align="center">
                        <form action="Upload_Project_Save.php" method="post" enctype="multipart/form-data">
                            <div>
                                ...
                                <tr>
                                    <td>
                                        <label for="email" class="signup_field" data-icon="u">Project Name:</label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div style="font-weight:bold; color:#FFFFFF;">Platform:</div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <label for="email" class="signup_field" data-icon="u">Project_Link:</label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <label for="Portrait" class="signup_field" data-icon="u">Project
                                            Screenshot:</label>
                                    </td>
                                    <td>
