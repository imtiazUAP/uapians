...
<div align="right" style="padding:20px; font-size:22px; font-weight:bold; color:#FFFFFF">Select Course:<br>
...
<div align="right" style="padding:20px; font-size:22px; font-weight:bold; color:#FFFFFF">Select Semester:<br>
...
<!--
 -->
    ...
    <p> <tr> <td>
         <label for="email" class="signup_field" data-icon="u">Topic Details:</label> </td>
         <td>
