                    ...
                    <div id="margin_figure" align="left">
	                    <div>
	                        <div id="paragraph_head">
                                <h1 align="left" style="color:#FFFFFF;font:Georgia, 'Times New Roman', Times, serif "><img src="images/system_images/welcome_icon_two.png">Welcome!</h1>
                            </div>
                        ...
                        <marquee behavior="scroll" direction="up"  style="vertical-align:middle;text-align:center; cursor:pointer;color:#0099FF; font-size:18px; height:300" onMouseOver="this.stop();" onMouseOut="this.start();" >
                            ...
                            while ($i < $num) {
                                ...
                                <a href='<?php echo $News_Link; ?>' target="_blank"
                                   style="text-decoration:none; color:#FFFFFF"><span><?php echo $News_Hints; ?></span></a>
                                <br> <br>
                                <?php
                                $i++;
                            }
