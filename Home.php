...
<a href='<?php echo $News_Link ; ?>'target="_blank" style="text-decoration:none; color:#FFFFFF"><span><?php echo $News_Hints ; ?></span></a><br> <br>

					<?php 
					if (($userdata[admin] == '1')) {
					?>

<td><?php echo " <a href='News_Edit.php?News_ID=" . $News_ID . "&keepThis=true&TB_iframe=true&height=300&width=500&do=edit&modal=true' class='thickbox' title='Edit Course - ".$News_ID."'> edit </a> "; ?> | <?php echo " <a href='News_Delete.php?News_ID=" . $News_ID . "'> delete </a> "; ?></td><br>
					<?php
					}
	 				?>
...
<td><?php echo " <a href='Notice_Edit.php?Notice_ID=" . $Notice_ID . "&keepThis=true&TB_iframe=true&height=300&width=500&do=edit&modal=true' class='thickbox' title='Edit Course - ".$Notice_ID."'> Update Notice </a> "; ?></td><br>
					<?php
					}
	 				?>
...
?>
	...
	<p align="left" style="font-size:16; font-weight:bold">UAPIANS.NET মুলত ইউনিভার্সিটি স্টুডেন্টদের মিলনমেলা...
	</p>
