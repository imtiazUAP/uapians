...
<form id="form1" name="form1" method="get" action="Student_Update.php">
    <table>
        ...
        <tr>
            <td>Transport:</td>
            <td><input name="STransport" type="text" id="STransport" value=" <?php echo $row["STransport"]; ?>"/></td>
        </tr>
        ...
        <tr>
            <td>Home_City:</td>
            <td><input name="SHome_City" type="text" id="SHome_City" value=" <?php echo $row["SHome_City"]; ?>"/></td>
        </tr>
