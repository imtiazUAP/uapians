...
class Page {
    ...
    function set_page_data($page_name, $sm_id, $total_records, $records_per_page=1, $scroll_num=0, $show_prev_next=true, $show_scroll_prev_next=false, $show_first_last=false) {
